...
function TavusRenderer() {
  ...
  return (
    <div style={{ 
      ...
      minHeight: '240px', 
      backgroundColor: '#000',
      borderRadius: '50%', /* Changed from 8px to 50% for a perfect circle */
      overflow: 'hidden',
      /* Center the container if it's not already */
      margin: '0 auto',
      /* Make sure the height and width are equal for a perfect circle */
      aspectRatio: '1/1'
    }}>
        ...
        <>
          <video 
            ...
            style={{ 
              ...
              height: '100%',
              objectFit: 'cover',
              borderRadius: '50%' /* Ensure video also has rounded edges */
            }}
          />
