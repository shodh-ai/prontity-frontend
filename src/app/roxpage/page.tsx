...
function RoxPageContent() {
  ...
  const handleLeave = () => {
    // Instead of redirecting, just log that we're leaving
              ...
              <div className="static top-0 w-full text-center py-4"> {/* Simplified and centered text */}
                ...
                <div className="bg-gray-50 p-4 my-4 rounded-lg border border-gray-200">
                  <div className="flex items-center justify-center mb-2">
                    ...
                    <span className="font-medium">{microphoneEnabled ? 'Microphone is active' : 'Microphone is off'}</span>
                  </div>
                  <p className="text-sm text-gray-500 text-center">
                    {microphoneEnabled 
                      ? 'Speak to Rox - your voice assistant is listening' 
                      : 'Use the microphone button in the top-right corner to start talking'}
                  </p>
                  {liveKitActive && <p className="text-xs text-blue-500 mt-1 text-center">LiveKit connection active</p>}
                </div>
              </div>
            </div>
          </div>
