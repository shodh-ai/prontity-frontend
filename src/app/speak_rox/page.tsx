              ...
              <Card className="bg-transparent border-none shadow-none">
                <CardContent className="px-0">
                  ...
                  <p className="font-['Plus_Jakarta_Sans',Helvetica] font-normal text-black text-base leading-16">
                    ...
                    there is a growing concern about the future of jobs and the
                    relevance of traditional education. What measures do you
                    think should be taken to ensure that education remains
                    effective in preparing individuals for the workforce.
                    <br />
                    <br />
                      ...
                      <>
                        {controlButtons.slice(0, 3).map((button) => {
                          ...
                          if (button.alt === "Settings") {
                            return (
                              <InlineTimerButton key="inline-timer-button" />
                            );
                          }
                          return null;
                        })}
