        ...
        <Card className="absolute top-[40px] left-[80px] w-[1280px] h-[740px] rounded-xl border-none shadow-none">
          <CardContent className="p-0 relative h-full">
            ...
            <div className="flex justify-between items-center p-4">
              <h2 className="font-semibold text-base font-['Plus_Jakarta_Sans',Helvetica]">
                {sessionData.title}
              </h2>
            ...
            <div className="flex mt-24">
              ...
              <div className="flex-1 px-10">
                ...
                <div className="flex flex-col w-[800px] items-start gap-3">
                  <h3 className="opacity-60 font-['Plus_Jakarta_Sans',Helvetica] font-semibold text-base">
                    Question
                  </h3>
                  <p className="font-['Plus_Jakarta_Sans',Helvetica] font-normal text-lg leading-[28.8px]">
                ...
                <div className="flex flex-col w-[725px] items-start gap-3">
                  ...
                  <div className="relative w-[725px]">
                    <p className="font-['Plus_Jakarta_Sans',Helvetica] font-normal text-lg tracking-[-0.06px] leading-[27px]">
